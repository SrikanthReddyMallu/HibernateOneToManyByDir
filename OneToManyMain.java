...
public static void main(String[] args) 
{
	...
	person1.setName("sumanth");
	person1.setPhno(778065033);
	person1.setGender("Male");
	
	Person person2=new Person();
	person2.setName("srikanth");
	person2.setPhno(77806033);
	person2.setGender("Male");
	
	Bank bank1=new Bank();
	bank1.setBname("SBI");
	bank1.setLocation("Marthahalli");
	bank1.setPhno(5667788);
	bank1.setIfsc("Sbinoo");
	
	Bank bank2=new Bank();
	bank2.setBname("SBIBang");
	bank2.setLocation("Bhommahahalli");
	bank2.setPhno(667788);
	bank2.setIfsc("SbinooBan");
